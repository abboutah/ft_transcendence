"""
Django settings for intrauth project.
...
SECRET_KEY = 'django-insecure-naz5(@)(_6$czb2rox2n7=hv3p(k&g3q&3^7ck(7!u(5cda)t9'
...
ROOT_URLCONF = 'intrauth.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS':  [BASE_DIR / "intrauth/templates",
